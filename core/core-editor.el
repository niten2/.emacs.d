...
;;; NOTE auto-mode-alist
(push '("/LICENSE\\'" . text-mode) auto-mode-alist)
(push '("\\.log\\'" . text-mode) auto-mode-alist)
(push '("xinitrc\\|xbindkeysrc\\|profile\\|bashrc\\|hosts\\|dunstrc\\|\\.env\\'" . sh-mode) auto-mode-alist)

(push '("config_pc\\|config_laptop\\|zsh_aliases\\|\\.env" . conf-mode) auto-mode-alist)
