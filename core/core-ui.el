...
;; (defvar doom-font (font-spec :family \"Source\ Code\ Pro" :size 12))
;; (defvar doom-font (font-spec :filename "Source\ Code\ Pro" :weight "semibold" :size 12))
;; (set-face-font 'default "Source Code Pro Semibold-9")
;; (setq doom-font "Source Code Pro Semibold-9:pixelsize=14")
...
;;;###package pos-tip
(setq pos-tip-internal-border-width 6 pos-tip-border-width 1)
