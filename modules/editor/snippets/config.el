;; http://joaotavora.github.io/yasnippet/snippet-expansion.html
...
(use-package! yasnippet
  ...
  (add-hook! '(text-mode-hook prog-mode-hook conf-mode-hook snippet-mode-hook) #'yas-minor-mode-on)

  :config
  (setq yas-verbosity (if doom-debug-mode 3 0) yas-also-auto-indent-first-line t)
  ...
  (after! smartparens (advice-add #'yas-expand :before #'sp-remove-active-pair-overlay))
...
;; NOTE hook yas
(advice-add #'yas-expand :after #'evil-normal-state)
