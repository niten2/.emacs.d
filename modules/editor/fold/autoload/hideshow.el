...
;;;###autoload
(defun +fold-hideshow-haml-forward-sexp-fn (arg) (haml-forward-sexp arg) (move-beginning-of-line 1))
...
;; (defun +ttn-hs-hide-level-1 () (hs-hide-level 1) (forward-sexp 1))
;; (defun +ttn-hs-hide-level-2 () (hs-hide-level 2) (forward-sexp 2))
;; (defun my-toggle-two () (interactive) (hs-hide-level 3) (forward-sexp 3))
