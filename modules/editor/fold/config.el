...
(use-package! hideshow
  ...
  (setq hs-hide-comments-when-hiding-all nil hs-set-up-overlay #'+fold-hideshow-set-up-overlay-fn)
    ...
    (setq hs-special-modes-alist
          (append
           '(
             ...
             (enh-ruby-mode "class\\|d\\(?:ef\\|o\\)\\|module\\|[[{]" "end\\|[]}]" "#\\|=begin" enh-ruby-forward-sexp nil)
