...
;; If nil, it is disabled in all modes, the same as if the +onsave flag wasn't used at all.
...
;; (when (featurep! +onsave) (add-hook 'after-change-major-mode-hook #'+format-enable-on-save-maybe-h))
