...
;;   (unless org-agenda-files (setq org-agenda-files (list org-directory)))
...
(defun +org-init-export-h ()
  (setq org-export-with-smart-quotes t org-html-validation-link nil)

  (when (featurep! :lang markdown) (add-to-list 'org-export-backends 'md))

  (use-package! ox-hugo :when (featurep! +hugo) :after ox)
...
(defun +org-init-protocol-lazy-loader-h ()
  ...
  (after! org-protocol (ad-disable-advice 'server-visit-files 'before 'org-protocol-detect-protocol-server)))
...
(use-package! org-clock
  ...
  (setq org-clock-persist 'history org-clock-in-resume t) (add-hook 'kill-emacs-hook #'org-clock-save))
...
(use-package! evil-org
  ...
  (map! :map evil-org-mode-map
        ...
        :i "C-l" (general-predicate-dispatch 'org-end-of-line (org-at-table-p) 'org-table-next-field)
        :i "C-h" (general-predicate-dispatch 'org-beginning-of-line (org-at-table-p) 'org-table-previous-field)
        :i "C-k" (general-predicate-dispatch 'org-up-element (org-at-table-p) '+org/table-previous-row)
        :i "C-j" (general-predicate-dispatch 'org-down-element (org-at-table-p) 'org-table-next-row)
        ...
        :nv "zi" #'flyspell-save-in-private-dictionary
