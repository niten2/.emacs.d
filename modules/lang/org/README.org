...
+ =+hugo= Enables integration with [[https://gohugo.io][hugo]] to export from Emacs well-formed ([[https://github.com/russross/blackfriday][blackfriday]]) markdown.
...
** Arch Linux
sudo pacman -S texlive-core texlive-bin texlive-science gnuplot
