...
(when-let (orglib (locate-library "org" nil doom--initial-load-path))
  (setq load-path (delete (substring (file-name-directory orglib) 0 -1) load-path))
)
...
(package! org-bullets :recipe (:host github :repo "Kaligule/org-bullets") :pin "8b4f0aab6d")
(package! org-yt :recipe (:host github :repo "TobiasZawada/org-yt") :pin "40cc1ac76d")
...
(when (featurep! :tools pdf) (package! org-pdfview :pin "8b71f31363"))
(when (featurep! :tools magit) (package! orgit :pin "e7cddf39e3"))
(when (featurep! +brain) (package! org-brain :pin "a0625854df"))
(when (featurep! +dragndrop) (package! org-download :pin "3c48102793"))
...
(when (featurep! +jupyter) (package! jupyter :pin "9e3c163358"))

(when (featurep! +pomodoro) (package! org-pomodoro :pin "aa07c11318"))

(when (featurep! +present)
  (package! centered-window :recipe (:host github :repo "anler/centered-window-mode") :pin "24f7c5be9d")
  (package! org-tree-slide :pin "7bf09a02bd")
  (package! ox-reveal :pin "aafedfd805")
)

(when (featurep! +journal) (package! org-journal :pin "dc120bf42a"))

;;; Babel
(package! ob-async :pin "80a30b96a0")
(when (featurep! :lang crystal) (package! ob-crystal :pin "d84c1adee4"))
(when (featurep! :lang go) (package! ob-go :pin "2067ed55f4"))
(when (featurep! :lang nim) (package! ob-nim :pin "bf1642cb93"))
(when (featurep! :lang racket) (package! ob-racket :recipe (:host github :repo "DEADB17/ob-racket") :pin "d8fd51bddb"))
(when (featurep! :lang rest) (package! ob-restclient :pin "c5c22e6035"))
(when (featurep! :lang rust) (package! ob-rust :pin "6a82587598"))
(when (featurep! :lang scala) (package! ob-ammonite :pin "39937dff39"))

;;; Export
(when (featurep! +pandoc) (package! ox-pandoc :pin "aa37dc7e94"))
