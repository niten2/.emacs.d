...
(use-package! markdown-mode
  ...
  (setq
        ...
        (cond (IS-MAC "open") (IS-LINUX "xdg-open"))
  ...
  (map! :map markdown-mode-map
        ...
        "p" #'markdown-preview
        "e" #'markdown-export
        "o" #'markdown-convert-buffer-to-org

        (:when (featurep! +grip) "p" . #'grip-mode)
...
(use-package! evil-markdown
  ...
  (add-hook 'markdown-mode #'outline-hide-sublevels)
  ...
  (map! :map evil-markdown-mode-map
        ...
        :n "zr"  #'markdown-show-all
        :n "zm"  #'markdown-hide-body
  )
)
