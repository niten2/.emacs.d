...
(when IS-WINDOWS (setenv "GIT_ASKPASS" "git-gui--askpass"))
...
(use-package! git-commit
  ...
  (setq git-commit-summary-max-length 50 git-commit-style-convention-checks '(overlong-summary-line non-empty-second-line))
