...
(after! ispell
  ...
  ;; If no module flags are given, enable either aspell or hunspell if their binary is found
  ;; If one of the flags `+aspell' or `+hunspell' is given, only enable that spell checker
...
(use-package! flyspell-correct
  ...
  :config
  (cond ((and (featurep! :completion helm) (require 'flyspell-correct-helm nil t)))
        ((and (featurep! :completion ivy) (require 'flyspell-correct-ivy nil t)))
...
(use-package! flyspell-lazy :after flyspell)

(defun flyspell-save-in-private-dictionary ()
  (interactive)
